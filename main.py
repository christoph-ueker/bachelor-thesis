...
# Required to make the progress bar work
...
# simulator and converter finished, we can proceed now
...
def new_channel(ori, tar, name, suffix):
    ...
    # proper positioning of self-edges and labels for SUT (maybe even dynamic readjusting)
    # maybe use nails, put label between nails
...
# print("R: " + str(R) + ", Avg Locs: " + str(float(total_loc_count / node_count)) + ", Avg Edges: "
#            + str(float(total_edge_count / node_count)))
print("UPPAAL is running now...")

# run UPPAAL and suppress its output
